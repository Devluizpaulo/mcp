...
const chatFlow = ai.defineFlow(
  ...
  async ({ history }) => {
    const { output } = await ai.generate({
      ...
      3. If the component is NOT found in the database with 'getComponentDetailsTool', then you must use the 'googleSearch' tool to find information about it on the web.
